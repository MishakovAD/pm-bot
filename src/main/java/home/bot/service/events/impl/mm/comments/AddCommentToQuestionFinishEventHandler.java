...
import static home.bot.dto.enums.MessageHandlerType.ADD_COMMENT_TO_QUESTION_MATTERMOST_FINISH;
...
@Service("MattermostAddCommentToQuestionFinishEventHandler")
public class AddCommentToQuestionFinishEventHandler extends AbstractEventHandler<BaseMattermostSubmitDialogRequest, Object> {

  private MattermostService mattermostService;
  private MessageHandlerService<BaseMattermostSubmitDialogRequest, ?> messageHandlerService;

  public AddCommentToQuestionFinishEventHandler(MattermostService mattermostService,
  ...
  private void processEvent(BaseMattermostSubmitDialogRequest event) {
    ...
    message.setText(ADD_COMMENT_TO_QUESTION_MATTERMOST_FINISH.getCommand());
