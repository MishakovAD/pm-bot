...
import static home.bot.dto.enums.MessageHandlerType.CREATE_USER_TASK_MATTERMOST_FINISH;
...
@Service("MattermostUserTaskCreateFinishEventHandler")
public class TaskCreateFinishEventHandler extends AbstractEventHandler<BaseMattermostSubmitDialogRequest, Object> {

  private MattermostService mattermostService;
  private MessageHandlerService<BaseMattermostSubmitDialogRequest, ?> messageHandlerService;

  public TaskCreateFinishEventHandler(MattermostService mattermostService,
  ...
  private void processEvent(BaseMattermostSubmitDialogRequest event) {
    EventMessage<BaseMattermostSubmitDialogRequest> message = buildEventMessage(event, event.getChannelId(), CREATE_USER_TASK_MATTERMOST_FINISH.getCommand());
