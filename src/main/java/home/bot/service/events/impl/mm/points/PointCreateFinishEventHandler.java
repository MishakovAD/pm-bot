...
import static home.bot.dto.enums.MessageHandlerType.CREATE_USER_POINTS_MATTERMOST_FINISH;
...
@Service("MattermostUserPointCreateFinishEventHandler")
public class PointCreateFinishEventHandler extends AbstractEventHandler<BaseMattermostSubmitDialogRequest, Object> {

  private MattermostService mattermostService;
  private MessageHandlerService<BaseMattermostSubmitDialogRequest, ?> messageHandlerService;

  public PointCreateFinishEventHandler(MattermostService mattermostService,
  ...
  private void processEvent(BaseMattermostSubmitDialogRequest event) {
    ...
    message.setText(CREATE_USER_POINTS_MATTERMOST_FINISH.getCommand());
